...
//Создай в классе Solution статические методы initList(List<Number> list), printListValues
// (List<Number> list), processCastedObjects(List<Number> list).
...
//Найди блок кода, в котором для каждого объекта списка проверяется тип и выводятся сообщения на экран, и
...
//4. Метод processCastedObjects должен анализировать элементы списка и для объектов типа Float или Double
// выводить на экран текст согласно условию задачи.

public class Z25MetodsType {
    ...
    static public void initList(List<Number> list) {
    ...
    static public void processCastedObjects(List<Number> list) {

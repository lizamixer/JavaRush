...
//3. Конструктор класса GenerateThread должен увеличивать значение createdThreadCount и передавать его в виде строки
...
public class Z22_GetNameSuperThread {
    static int count = 15;
    ...
    public static class GenerateThread extends Thread {
        ...
        public void run() {
            if (createdThreadCount < Z22_GetNameSuperThread.count) {
                System.out.println(new GenerateThread());
            }
        }
    }

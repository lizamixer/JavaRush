...
//4. Методы run всех игроков которые не стали победителями (были прерваны), должны вывести надписи getName()
// + ":проиграл". Например: Petrov:проиграл
//5. Метод run не должен кидать исключение при прерывании.

public class Z27_GetNameThreadInterruptFlag {

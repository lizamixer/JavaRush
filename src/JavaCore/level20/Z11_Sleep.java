...
//4. Метод doStep должен учитывать скорость бегуна. Если скорость бегуна 2 шага в секунду, метод должен
...
public class Z11_Sleep {
    ...
    public static class Stopwatch extends Thread {
        ...
        private void doStep() throws InterruptedException {
            ...
            Thread.sleep(1000/owner.getSpeed());                                //добавила только эту строку

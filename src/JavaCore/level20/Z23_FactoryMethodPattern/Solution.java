...
//4.2. Если передан неправильный параметр (в т.ч. null), то выбрасывать исключение IllegalArgumentException
...
import JavaCore.level20.Z23_FactoryMethodPattern.common.ImageReader;
import JavaCore.level20.Z23_FactoryMethodPattern.common.ImageTypes;

public class Solution {                         //этот файл тоже был по условию

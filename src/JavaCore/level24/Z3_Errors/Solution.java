package JavaCore.level24.Z3_Errors;
...
public class Solution {
    ...
    public static class Human {
        ...
        public boolean equals(Object o) {
            if (this == o) return true; //тут был фолс
            if (o == null || getClass() != o.getClass()) return false;

            Human human = (Human) o;

            if (name != null ? !name.equals(human.name) : human.name != null) return false; //тут в начале в скобках было ==

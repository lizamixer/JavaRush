...
public class Z8_SynchronizedJoin {
    public static void main(String[] args) throws InterruptedException {
        ...
        counter1.start();
        counter1.join(); //везде проставила джоины
        counter2.start();
        counter2.join();
        counter3.start();
        counter3.join();
    ...
    public static class Counter extends Thread {
        ...
        public void run() {
            do {
                synchronized (Z8_SynchronizedJoin.class) { //заменила this на Z8_SynchronizedJoin.class
                    incrementCount();
                    values[getCount()]++;
                }

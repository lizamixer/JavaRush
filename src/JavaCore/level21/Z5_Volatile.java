...
//Поэтому сделай так, чтобы лист notes находился в общей памяти, Т.е не будет
// кэшироваться потоками в свою локальную область памяти.
//Requirements:
...
public class Z5_Volatile {
    ...
    public static class Note {
        ...
        public volatile List<String> notes = new ArrayList<String>();               //добавила volatile просто

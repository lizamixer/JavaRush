...
public abstract class ApplicationContext <GenericsBean extends Bean> {
    ...
    public synchronized GenericsBean getByName(String name) {  //сделала синхронизированным
        return container.get(name);
    }

    public synchronized GenericsBean removeByName(String name) {  //сделала синхронизированным

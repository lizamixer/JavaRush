...
маленькой программе это, скорее всего, заметно не будет), то попробуй как будет работать программа без synchronized
...
public class Z13_Synchronized {
    ...
    public synchronized static void printInfo(String name, int age) {
        for (int i = 1; i <= 5; i++) {
            //synchronized (Solution.class) {                       //скрыла этот блок
            System.out.print(i);
            System.out.print(".");
            System.out.print(" ");

package JavaCore.level21.Z12_RandomMapThreadSynchronized;
...
public class DrugsController {
    ...
    public synchronized void buy(Drug drug, int count) { //тут выставила синхронизацию
    ...
    public synchronized void sell(Drug drug, int count) { //тут выставила синхронизацию

...
//2. Метод initializeIdAndName должен возвращать корректный объект типа User, объект на
// котором производится вызов метода("этот" объект).
...
public class Z17Interface {
    ...
    static class User implements DBObject {
        ...
        @Override
        public User initializeIdAndName(long id, String name) { //тут надо было поменять тип возвращаемого объекта на User
            this.id = id;
            this.name = name;
            return this;
        }

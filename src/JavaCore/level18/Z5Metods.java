...
public class Z5Metods {
    ...
    public static void foodMethods(Food food) { //тут просто прописала методы
        //тут добавьте вызов методов для переменной food
        food.onSelect();
        food.onEat();
    }

    public static void selectableMethods(Selectable selectable) { //и тут тоже прописала метод

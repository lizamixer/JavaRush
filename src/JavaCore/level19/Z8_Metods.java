...
public class Z8_Metods {
    ...
    public static class NormalCat extends NakedCat {
        public NormalCat() { //Ежели мы указали хотя бы одну реализацию конструктора,
                             // то теперь если нам нужен конструктор по умолчанию — его нужно создавать вручную.
        }

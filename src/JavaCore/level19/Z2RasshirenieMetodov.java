...
public class Z2RasshirenieMetodov {
    public static void main(String[] args) {
        new Z2RasshirenieMetodov.LuxuriousCar().printlnDesire();
        new Z2RasshirenieMetodov.CheapCar().printlnDesire();
        new Z2RasshirenieMetodov.Ferrari().printlnDesire();
        new Z2RasshirenieMetodov.Lanos().printlnDesire();
    }
